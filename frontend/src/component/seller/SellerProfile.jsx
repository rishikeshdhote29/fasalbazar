...
import {fetchSellerAction, fetchUserAction} from "../../redux/userSlice.js";
			...
			<div className=' border bg-grey-300 p-4  mt-10   rounded-lg shadow-md'>
				...
				<div className='mt-6 grid gap-4 sm:grid-cols-2'>
					...
					<p className='text-lg  ms-10'><span className='font-semibold'>Email:</span> {user?.email||"not available"}</p>
					 ...
					 <p className='text-lg  ms-10'><span className='font-semibold'>Role:</span> {user?.role||"not" +
						 " available"}</p>
				...
				< div className={"flex justify-center"}>
					<button onClick={()=>navigate("/update-seller-profile")} className={"bg-amber-400 p-1 px-15" +
						" rounded-lg"}>
				update profile
				</button>
				</div>
